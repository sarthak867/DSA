<h2><a href="https://leetcode.com/problems/minimum-increase-to-maximize-special-indices">4149. Minimum Increase to Maximize Special Indices</a></h2><h3>Medium</h3><hr><p>You are given an integer array <code>nums</code> of length <code>n</code>.</p>
